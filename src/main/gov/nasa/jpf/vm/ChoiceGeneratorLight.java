...
public abstract class ChoiceGeneratorLight<T> implements ChoiceGenerator<T> {
    public static enum ChoiceRandomizationPolicy {
    ...
    static ChoiceGeneratorLight.ChoiceRandomizationPolicy randomization;
    ...
    public static void init(Config config) {
        ...
        randomization = config.getEnum("cg.randomize_choices",
                ChoiceGeneratorLight.ChoiceRandomizationPolicy.values(), ChoiceGeneratorLight.ChoiceRandomizationPolicy.NONE);

        // if the randomize_choices is set to random then we need to
        // pick the seed based on the system time.

        if (randomization == ChoiceGeneratorLight.ChoiceRandomizationPolicy.VAR_SEED) {
            random.setSeed(System.currentTimeMillis());
        } else if (randomization == ChoiceGeneratorLight.ChoiceRandomizationPolicy.FIXED_SEED){
    ...
    public static boolean useRandomization() {
        return (randomization != ChoiceGeneratorLight.ChoiceRandomizationPolicy.NONE);
    }

    protected ChoiceGeneratorLight() {
    }

    @Override
    public ChoiceGeneratorLight<?> clone() throws CloneNotSupportedException {
        return (ChoiceGeneratorLight<?>)super.clone();
    }
    ...
    @Override
    public String getId() {
        throw new RuntimeException("Not supported by light version");
    }
